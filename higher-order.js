...
//Code Here
let totalPopulation=populations.reduce((prev,cur)=>prev+cur);//  = populations.reduce(/* Provide Your Callback Here */)
...
let ordersTotal=orders.map(val=>val.price+val.price*val.tax); //Code Here
...
let bobsTotal=purchases.reduce(function (prev,cur){ 
  if (cur.owner==="Bob") {
